...
<!-- /.main-menu -->
  ...
  <img src="logo.jpg" href="../index.php" alt="logo" style="max-width:400px">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Mobile no is reauired">
						...
						<input class="input100" type="text" name="mob" placeholder="Type your username">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Re-Password is required">
						...
						<input class="input100" type="text" name="pass_1" placeholder="Type your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
...
<?php 
   ...
   if(isset($_POST['signup'])){
    ...
    $add_user = "INSERT INTO `user` (`user_name`, `user_fname`, `user_mail`, `user_mob`, `user_pwd`) VALUES ('$username','$fullname','$mail','$mob','$pass')";
    ...
    if($run)
       {
        ...
        $req = "INSERT INTO `otp`(`user_name`, `user_mail`, `otp`,`date`) VALUES ('$username','$mail','null',NOW())";
