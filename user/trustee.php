		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				 <li>
					...
					<a class="waves-effect" href="#"><i class="menu-icon fa fa-user"></i><span>Password reset</span></a>
				</li>
...
<!-- /.main-menu -->
	...
	<div class="pull-left">
		...
		<h1 class="page-title">Cloud file browser</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Mail iD is reauired">
						<span class="label-input100">Trustee Mail</span>
						<input class="input100" type="text" name="tmail" placeholder="Type your username">
 ...
 <script src="assets/scripts/jquery.min.js"></script>
   ...
   if(isset($_POST['login'])){
        ...
        $get_trustee = "SELECT * FROM `trustee` WHERE `trust_mail` = '$tmail' AND `trust_pwd` = '$pass'";
        
        $run_trustee = mysqli_query($con,$get_trustee);
        
        $check_trustee = mysqli_num_rows($run_trustee);
        ...
        
       {
           ...
           echo" <script>window.open('../trustee/index.php','_self')</script>";
                
                
        }
        else
        {
         echo"<script> alert('Login Unuccesfull')</script>";
    
          echo"<script>window.open('trustee.php','_self')</script>";
