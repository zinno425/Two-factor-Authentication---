		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				 <li>
					...
					<a class="waves-effect" href="#"><i class="menu-icon fa fa-user"></i><span>Cloud dashboard</span></a>
				</li>
...
<!-- /.main-menu -->
	...
	<div class="pull-left">
		...
		<h1 class="page-title">Authority Panel</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Mail id is reauired">
						<span class="label-input100">Authority Mail</span>
 ...
 <script src="assets/scripts/jquery.min.js"></script>
   ...
   if(isset($_POST['login'])){
        ...
        $get_auth = "SELECT * FROM `authority` WHERE `auth_mail` = '$mail' AND `auth_pwd` = '$pass'";
        
        $run_auth = mysqli_query($con,$get_auth);
        
        $check_auth = mysqli_num_rows($run_auth);
        ...
        
       {
           ...
           echo"<script> window.open('../authority/index.php','_self')</script>";
