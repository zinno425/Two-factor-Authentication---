...
<!-- /.main-menu -->
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="" >
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" type="password" name="otp" placeholder="Type your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
 ...
 <script src="assets/scripts/jquery.min.js"></script>
   ...
   if(isset($_POST['login'])){
        ...
        $get_user = "SELECT * FROM `user` WHERE `user_name` = '$username' AND `user_otp` = '$otp'";
      ...
      $run_user = mysqli_query($con,$get_user);
        ...
        
       {
           ...
           echo"<script>  window.open('../dashboard/index.php?name=$username','_self')</script>";
        ...
        else
        {
         ...
         echo"<script>window.open('opt_verify1.php','_self')</script>";
