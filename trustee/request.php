...
<body>
      <div class="main-menu">
	<header class="header">
		<a href="index.html" class="logo">TRUSTEE DASHBOARD</a>
		<button type="button" class="button-close fa fa-times js__menu_close"></button>
		<div class="user">
			<a href="#" class="avatar"><img src="http://placehold.it/80x80" alt=""><span class="status online"></span></a>
			<h5 class="name"><a href="#"></a></h5>
			<h5 class="position">Trustee</h5>
			<!-- /.name -->
	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
                <li>
					<a class="waves-effect" href="request.php"><i class="menu-icon fa fa-user"></i><span>REQUESTS</span></a>
				</li>
				
                <li>
					<a class="waves-effect" href="userlist.php"><i class="menu-icon fa fa-user"></i><span>USER'S</span></a>
				</li>
            ...
            <table style="border-collapse: collapse;width:100%;">
                <thead>
                  ...
                  <?php 
                                ...
                                while($row_req = mysqli_fetch_array($run_req)){
                                    ...
                                    $u_name = $row_req['user_name'];
                                    $u_mail = $row_req['user_mail'];
                                    $otp = $row_req['otp'];
                                    $date = $row_req['date'];
             ...
             <tbody>
                <tr>
                    ...
                    <td><a href="send_otp.php?req_id=<?php echo $req_id ?>">Send key</a></td>
