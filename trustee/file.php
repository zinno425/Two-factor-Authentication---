	...
	<div class="main-content">
		<div class="row small-spacing">
            ...
            <table style="border-collapse: collapse;width:100%;">
                <thead>
                  ...
                  <?php 
                                ...
                                $get_file = "select * from file";
          
                                $run_file = mysqli_query($con,$get_file);
          
                                while($row_file = mysqli_fetch_array($run_file)){
                                    $file_id = $row_file['file_id'];
                                    $f_name = $row_file['file_name'];
                                    $f_size = $row_file['file_size'];
                                    $f_type = $row_file['file_type'];
                                    $date = $row_file['date'];
                                    $key = $row_file['file_key'];
             ...
             <tbody>
                <tr>
                    ...
                    <td><?php echo " $date "; ?></td>
                    <td><a href="delete.php?file_id=<?php echo $file_id ?>">Delete</a></td>
                    <td><?php if($key == "null"){
                                echo "Not assigned";
                            }
                        else
            ...
            <div class="col-md-4 text-center">
                   <br /> <br /> <br /> <br /> <br /> <br />
                <a href="upload.php"><button class="btn btn-info">UPLOAD</button></a>
