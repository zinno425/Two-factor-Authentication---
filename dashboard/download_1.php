	...
	<div class="main-content">
		<div class="row small-spacing">
            ...
            <div class="col-md-8">
                ...
                <h3 class="text-center">DOWNLOAD STEP 2</h3>
                <br/>
           ...
           <div class="row small-spacing text-center">
               ...
               <h5>Enter the key</h5>
                    ...
                    <input type="text" name="key" style="width:800px"/> 
                
                </div><br /> 
                <div class="row small-spacing text-center">
               
                <button class="btn btn-success" name="proceed">Proceed</button>
                </div>
 ...
 <script src="assets/scripts/jquery.min.js"></script>
    ...
    <?php
      ...
      if(isset($_POST['proceed'])){
          ...
          $req = "SELECT * FROM `file` WHERE `file_id` = '$file_id'";
          ...
          if($key_f == $key){
              ...
              echo "<script> alert('Key verified'); </script>";
              
              echo "<script> window.open('download_2.php?file_id=$f_name','_self') </script>";
